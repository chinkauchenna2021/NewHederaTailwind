      ...
      <MainLayout>
          ...
          <S.ScrollBar className='w-full h-[450px] overflow-y-scroll'>
              ...
              <div className=' w-full  mt-2 rounded-lg relative'>
                    <div className='w-full h-10 flex justify-center items-center uppercase text-sm font-bold text-white tracking-wide'> your portfolio</div>
                  <div className='w-full h-fit space-y-6 '>
                      <div className="tracking-wider text-center text-4xl font-bold text-white pt-6">$0.00</div>
                      <div className="w-full flex justify-center items-center space-x-3">
                          <div className="border border-slate-200 w-fit flex flex-row px-2 py-2 rounded-full space-x-2"><span className="font-semibold text-sm text-white">0x273...37463</span><span className=""><MdCopyAll size={18} color='#ffffff' /></span></div>
                           <div className="h-9 w-9 border border-slate-100 rounded-full flex justify-center items-center"><MdRemoveRedEye size={18} color='#ffffff' /></div>
                      </div>
                      <div className="flex justify-center items-center space-x-3">
                          <div className="cursor-pointer w-6/12 h-10 bg-[#FFE569]/70 flex justify-center items-center py-1 px-3 rounded-md space-x-4">
                          ...
                          <div onClick={()=>navigate("/send")} className="cursor-pointer h-10 w-6/12 bg-[#FFE569]/70 flex justify-center items-center py-1 px-3 rounded-md space-x-4">
              ...
              <div className='h-fit w-full backdrop-blur-lg bg-white/100 mt-4 rounded-lg px-4'>
                  <div className="w-full uppercase px-2 font-semibold flex justify-start items-center py-1 text-black/60">available Tokens ({<div className='text-blue-600/70 font-bold ' >{1}</div>})</div>
